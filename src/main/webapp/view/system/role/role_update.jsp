...
<body>
	...
	<form action="RoleUpdateServlet" method="post" class="form-horizontal">
		...
		<div class="row">
			<div class="col-xs-8">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" name="roleName" value="${role.roleName }" class="form-control" placeholder="请输入角色名称" />
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-xs-8">
				<div class="form-group ">
					...
					<div class="col-xs-9">
						<textarea rows="10" name="roleDesc" cols="80" placeholder="请输入描述信息">${role.roleDesc }</textarea>
					</div>
				</div>
			</div>
