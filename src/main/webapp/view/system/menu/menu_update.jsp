...
<div style="margin: 0px; padding: 0px;">
	...
	<form action="MenuUpdateServlet" class="form-horizontal" method="post">
		...
		<div class="row">
			<div class="col-xs-6">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control" name="menuName" value="${menu.menuName }" placeholder="请输入菜单名称" />
					</div>
				</div>
			</div>
		<div class="col-xs-6">
		...
		<div class="row">
			<div class="col-xs-9">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control" name="menuUrl"  value="${menu.menuUrl }"   placeholder="请输入菜单URL" />
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-xs-8">
				<div class="form-group ">
					...
					<div class="col-xs-9">
						<textarea rows="10" cols="80" name="menuRemarks" placeholder="请输入菜单备注"> ${menu.menuRemarks }</textarea>
					</div>
				</div>
			</div>
