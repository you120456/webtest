				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						...
						<ul
							...
							<li><a href="UserLoginServlet"> <i class="icon-off"></i> 退出
							</a></li>
						</ul></li>
				</ul>
				<!-- /.ace-nav -->
		...
		<div class="main-container-inner">
								 ...
								 <ul class="submenu">
									<c:forEach items="${loginmenulist }" var="lm2">
										<c:if test="${lm.menuId==lm2.menMenuId }">
											<li><a href="${lm2.menuUrl }" target="mainframe"> <i
													class="icon-double-angle-right"></i> ${lm2.menuName }
											</a></li>
										</c:if>
									</c:forEach>
								</ul></li> 
			...
			<div class="main-content" id="mains">
				<iframe id="mainframe" name="mainframe" src="main.jsp"
					style="width: 100%; border: 0px;" scrolling="yes"> </iframe>
			</div>
